...
2. Click the UgandaEMR reports link as in the image below
   ...
   ![UgandaEMR link](../images/homepage_ugandaemr_reports_link.png)

3. On the Reports dashboard click the link to 106A Section 1A

   ![Reports Dashboard - 106A Section 1A link](../images/reports_dashboard_106a_1a_link.png)

4. Enter the start date and end date for the quarter you wish to generate the report, then click the Run button

   ![106A 1A parameters](../images/106A_1A_parameters.png)

5. This report will run for a while as shown by the progress icon 

   ![106A Section 1A processing](../images/106A_1A_currently_processing.png)
...
![106A 1B Completed](../images/106A_1A_download_preserve.png)
